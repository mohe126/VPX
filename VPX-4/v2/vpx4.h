...
static inline uint16_t vpx4_endian_fmt16(uint16_t val){
...
//[[ TYPEDEFs ]]
typedef struct Vpx4 Vpx4;
typedef void (*vpx4_instruction_t)(Vpx4*);
...
void vpx4_config_reg(Vpx4* vpx4, vpx4_register_t registers);
